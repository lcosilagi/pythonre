...
print('Aplicado re para achar somente os nomes seguidos do sobrenome Simpson diferentes de Homer:')
print('Negative Lookbehind: re.findall(r\'.*\(?<!Homer\s\)Simpson\',id)\n')
tam = len(exemplo)
